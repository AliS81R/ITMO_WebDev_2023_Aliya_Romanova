import DOM from "../../contants/dom.js";
...
class TaskPopup {
  ...
  #confirmCallback;
  #closeCallback;
  constructor(title, confirmText, tags, confirmCallback, closeCallback) {
    this.#title = title;
    this.#tags = tags;
  ...
  render() {
    ...
    div.innerHTML = ` <div class="flex flex-col relative min-w-[377px] bg-white p-6 rounded-2xl gap-y-4">
    ...
    <div class="flex flex-row pt-2">
      <button data-id="btnConfirm" class="bg-teal-600 text-white p-2 rounded-lg w-full font-bold">Create</button>
    </div>
  </div>
</div>`;
    ...
    const domInputTitle = popup.querySelector(`[data-id="inpTitle"]`);
